...
data = pd.read_excel('hesac.xlsx')
data_t = pd.read_excel('testing.xlsx')

X_train=data['English'].values
X_val=data_t['English'].values
y_train=data['Polarity'].values
y_train = y_train.astype(np.int64)
y_val=data_t['Polarity'].values
